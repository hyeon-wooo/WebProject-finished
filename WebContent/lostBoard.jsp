...
<body>
  ...
  <div class="dropdown-content">
    ...
    <a href="lostBoard.jsp?pageNum=1">찾는 게시판</a>
	 ...
	 <h1 style="margin-top:150px; margin-left:200px; width:350px;">반려견을 
            찾습니다</h1>
<hr>
   ...
   <div style="margin-left:50px;">
	...
	<% 
	ResultSet rs = null;
	double temp = (double)DBC.getCountRecords("lost_page");
	...
	if (strPage != null) {
		...
		rs = DBC.getSelectRs("lost_page", curPage);
	...
	%> 
			<tr>
			<td><%= no %></td>
			<td><a href="article.jsp?no=<%= no %>&boardType=lost_page"><%= title %></a></td>
			<td><%= name %></td>
			<td><%= date %></td>
			<td><%= hit %></td>
			</tr>
	...
	<% for (int i = 1; i<=endPage; i++) { %>
		<a href="lostBoard.jsp?pageNum=<%= i %>"><%= i %></a>
	<% } %>
	</div>
