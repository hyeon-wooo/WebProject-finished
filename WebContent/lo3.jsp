...
>
    ...
    <br /><br /><br /><br />
    <aside id="left">
    <h1 style="width: 223px">경기지역</h1>
    <ul>

    <li><a href="lo2.jsp">서울</a></li>
    <li><a href="location.jsp">인천</a></li>
    <li id="curPage"><a href="lo3.jsp">경기</a></li>
...
<h5><b>남양유기견보호센터</b></h5>
Tel.031-355-7534<br />
경기 화성시 남양읍 화성로 1483-27(남양읍 북양리 12-2)

<div id="daumRoughmapContainer1541097429705" class="root_daum_roughmap root_daum_roughmap_landing"></div>
<script charset="UTF-8" class="daum_roughmap_loader_script" src="http://dmaps.daum.net/map_js_init/roughmapLoader.js"></script>

<script charset="UTF-8">
	new daum.roughmap.Lander({
		"timestamp" : "1541097429705",
		"key" : "qoto",
		"mapWidth" : "300",
		"mapHeight" : "150"
	}).render();
...
<div>
    <ul>
        <li>
           <h5><b>유기동물보호센터</b></h5>
경기 용인시 처인구 중부대로 1074-1(삼가동 164)
<div id="daumRoughmapContainer1541097700680" class="root_daum_roughmap root_daum_roughmap_landing"></div>

<script charset="UTF-8">
	new daum.roughmap.Lander({
		"timestamp" : "1541097700680",
		"key" : "qotp",
		"mapWidth" : "300",
		"mapHeight" : "150"
	}).render();
    ...
    <div>
        <ul>
            <li>
평택시유기동물보호소<br />
Tel.031-8024-3849 <br />
경기 평택시 진위면 야막길 88-37

<div id="daumRoughmapContainer1541098172231" class="root_daum_roughmap root_daum_roughmap_landing"></div>
<script charset="UTF-8">
	new daum.roughmap.Lander({
		"timestamp" : "1541098172231",
		"key" : "qotq",
		"mapWidth" : "300",
		"mapHeight" : "150"
	}).render();
